...
/**
 * WP Bootstrap Navwalker Mobile
 *
 * @package WP-Bootstrap-Navwalker-Mobile
 */
	...
	class WP_Bootstrap_Navwalker_Mobile extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( '' !== $linkmod_type ) {
				...
				$item_output .= '</a>';
				if ( $args->has_children ) {
					$item_output .= '<a class="t dropdown-toggle" href="#" aria-expanded="false" data-toggle="dropdown"><span></span></a>';
				}
			}
